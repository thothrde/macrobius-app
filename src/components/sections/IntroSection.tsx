  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* 🏛️ NEW: MACROBIUS HISTORICAL TEXT SECTION */}
        <div style={{
          marginBottom: '80px',
          padding: '50px',
          backgroundColor: 'rgba(255, 255, 255, 0.95)',
          ...
          <div style={{ position: 'relative', zIndex: 2 }}>
            ...
            <div style={{
              ...
              <p style={{ margin: '0 0 24px 0' }}>
                **Vor 1500 Jahren, als das römische Reich dem Untergang entgegensah, 
                ...
                Ermutigung und Materialquelle.**
              </p>
              
              <p style={{ margin: '0 0 24px 0' }}>
                **Vor 500 Jahren begann dieser Neuanfang. In Dänemark durch astronomische 
                ...
                eine zuverlässige und kommentierte Gesamtausgabe zusammen.**
              </p>
              
              <p style={{ margin: '0' }}>
                **Dieses Buch kam in meine Hände und ich auf die Idee, eine kleine App 
                für euch zu dieser Geschichte zu basteln.... Viel Spaß!**
              </p>
            </div>
            ...
            <div style={{
              ...
              <div style={{
                borderRadius: '16px',
                overflow: 'hidden',
                boxShadow: '0 20px 40px rgba(0, 0, 0, 0.2), 0 0 0 3px rgba(212, 175, 55, 0.3)',
                ...
                <img
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.parentElement!.style.boxShadow = '0 30px 60px rgba(0, 0, 0, 0.3), 0 0 0 3px rgba(212, 175, 55, 0.5)';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.transform = 'scale(1)';
                    e.currentTarget.parentElement!.style.boxShadow = '0 20px 40px rgba(0, 0, 0, 0.2), 0 0 0 3px rgba(212, 175, 55, 0.3)';
                  }}
                />
                <div style={{
                  padding: '20px',
